// NBAEdge v3 — Live backend connected
...
const ios = {
  ...
  sep:    "#38383A", amber: "#FF9F0A", green: "#30D158",
  red:    "#FF453A", blue: "#0A84FF", purple: "#BF5AF2", teal: "#5AC8FA",
  font:   "-apple-system,'SF Pro Display',system-ui,sans-serif",
  mono:   "'SF Mono','Fira Mono',monospace",
};

// ─── API CLIENT ───────────────────────────────────────────────
async function apiFetch(path, timeout = 90000) {
...
function ConfRing({ value, size = 52 }) {
  ...
  const fill = (value / 100) * circ, col = cc(value);
  return (
    <div style={{ position: "relative", width: size, height: size, flexShrink: 0 }}>
      ...
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column",
        ...
        <span style={{ fontFamily: ios.font, fontWeight: 700,
          fontSize: size > 44 ? 14 : 11, color: col, lineHeight: 1 }}>{value}</span>
    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column",
      ...
      <div style={{ width: "100%", maxWidth: 280 }}>
        <div style={{ height: 3, background: ios.bg3, borderRadius: 99, overflow: "hidden" }}>
          <div style={{
            height: "100%", background: ios.amber, borderRadius: 99,
            width: `${progress}%`,
      ...
      <div style={{ textAlign: "center" }}>
        <div style={{ fontFamily: ios.font, fontSize: 15, color: ios.label2,
          marginBottom: 6 }}>{message}</div>
      ...
      <div style={{ background: ios.bg1, borderRadius: 14, padding: "12px 16px",
        ...
        {[
          { icon: "📊", label: "NBA.com official stats" },
...
function ErrBanner({ msg, onRetry }) {
  return (
    <div style={{ margin: "12px 20px", background: "rgba(255,69,58,0.12)",
      borderRadius: 14, padding: "14px 16px", border: `1px solid ${ios.red}33` }}>
      <div style={{ fontFamily: ios.font, fontWeight: 600, fontSize: 14,
        color: ios.red, marginBottom: 6 }}>⚠️ Connection Error</div>
      <div style={{ fontFamily: ios.font, fontSize: 13, color: ios.label3,
        marginBottom: 10 }}>{msg}</div>
      <button onClick={onRetry} style={{ background: ios.red, border: "none",
        borderRadius: 8, padding: "8px 16px", color: "#fff",
        fontFamily: ios.font, fontSize: 14, fontWeight: 600, cursor: "pointer" }}>
        Try Again
      </button>
    </div>
  );
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 200, background: ios.bg1,
      ...
      <div style={{ padding: "12px 20px 0", flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between",
          ...
          <button onClick={onClose} style={{ background: ios.bg3, border: "none",
            borderRadius: 99, width: 30, height: 30, color: ios.label2, fontSize: 16,
      ...
      <div style={{ padding: "0 20px 60px" }}>
        ...
        {/* Model projections */}
        {(leg.projected_margin !== undefined || leg.projected_total !== undefined) && (
          <div style={{ background: ios.bg2, borderRadius: 16, padding: 16, marginBottom: 14 }}>
            ...
            {leg.projected_margin !== undefined && (
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                <span style={{ fontFamily: ios.font, fontSize: 14, color: ios.label2 }}>Projected margin</span>
                <span style={{ fontFamily: ios.font, fontWeight: 700, fontSize: 14, color: ios.amber }}>
                  {leg.projected_margin > 0 ? "+" : ""}{leg.projected_margin}
                </span>
              </div>
            )}
            {leg.projected_total !== undefined && (
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
            ...
            {leg.edge !== undefined && (
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span style={{ fontFamily: ios.font, fontSize: 14, color: ios.label2 }}>Edge vs line</span>
                <span style={{ fontFamily: ios.font, fontWeight: 700, fontSize: 14,
                  color: leg.edge > 0 ? ios.green : ios.red }}>
                  {leg.edge > 0 ? "+" : ""}{leg.edge} pts
                </span>
              </div>
            )}
          </div>
        ...
        <div style={{ background: "rgba(255,159,10,0.1)", borderRadius: 12,
          ...
          ⚠️ Analytical estimates only. Always verify lineups at tip-off. Bet responsibly.
        </div>
      </div>
    </div>
  );
      ...
      <div style={{ flex: 1, overflowY: "auto", background: ios.bg, paddingBottom: 100 }}>
        ...
        <div style={{ padding: "20px 20px 0" }}>
          ...
          <div style={{ background: `linear-gradient(145deg,${pick.accentColor}20,${ios.bg1})`,
            border: `1px solid ${pick.accentColor}33`, borderRadius: 20,
            ...
            <div style={{ fontFamily: ios.font, fontSize: 14, color: ios.label3,
              ...
              combined odds · {legs.length} leg{legs.length !== 1 ? "s" : ""}
            </div>
            <div style={{ display: "flex", gap: 12 }}>
              ...
              <div style={{ flex: 1, background: ios.bg1, borderRadius: 12, padding: "10px 14px" }}>
                ...
                <div style={{ fontFamily: ios.font, fontWeight: 700, fontSize: 22,
                  color: ios.label }}>{legs.length}</div>
              </div>
            </div>
          </div>
          ...
          {legs.length === 0 ? (
            <div style={{ background: ios.bg1, borderRadius: 16, padding: 24,
              ...
              Odds not yet posted for enough games to build this multi.
            ...
            <>
              <div style={{ fontFamily: ios.font, fontWeight: 600, fontSize: 13,
                ...
                BET LEGS — TAP FOR FULL ANALYSIS
              </div>
              {legs.map((leg, i) => {
                const col = cc(leg.confidence);
                return (
                  <div key={i} onClick={() => setSel(leg)}
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontFamily: ios.font, fontSize: 12,
                        color: ios.label3, marginBottom: 2 }}>{leg.game}</div>
                      ...
                      <div style={{ display: "flex", gap: 5, flexWrap: "wrap", alignItems: "center" }}>
                        <span style={{ fontFamily: ios.font, fontSize: 12,
                          color: ios.amber, fontWeight: 600 }}>{leg.odds?.toFixed(2)}×</span>
                        <span style={{ fontFamily: ios.font, fontSize: 11,
                          color: ios.label3 }}>{leg.type}</span>
                        {(leg.tags || []).map(t => <PillTag key={t} label={t} />)}
                      </div>
                    </div>
          ...
          {(pick.alts || []).length > 0 && (
            <>
              ...
              <div style={{ background: ios.bg1, borderRadius: 16,
...
// ─── PICKS TAB ────────────────────────────────────────────────
function PicksTab({ picks, loading, loadingMsg, loadingProgress, error, onRetry, lastUpdated, legsScored, gamesAnalyzed }) {
  const [detail, setDetail] = useState(null);

  if (detail && picks?.[detail]) {
    return <PickScreen pick={picks[detail]} onBack={() => setDetail(null)} />;
  }
        ...
        <>
          ...
          <div style={{ margin: "8px 20px 16px", background: ios.bg1, borderRadius: 14,
            ...
            <div style={{ fontFamily: ios.font, fontSize: 13, color: ios.label3, lineHeight: 1.5 }}>
              ...
              {gamesAnalyzed} games · {legsScored} legs scored · NBA.com + ESPN + bookmaker odds
            </div>
          </div>
                ...
                <div style={{ background: `linear-gradient(135deg,${pick.accentColor}18,transparent)`,
                  ...
                  <div>
                    <div style={{ fontFamily: ios.font, fontWeight: 700, fontSize: 18,
                      color: ios.label, marginBottom: 3 }}>
                    ...
                    <div style={{ display: "flex", gap: 5 }}>
                      {(pick.legs || []).slice(0, 6).map((l, i) => (
                        <div key={i} style={{ width: 8, height: 8, borderRadius: "50%",
                          background: cc(l.confidence), opacity: 0.85 }} />
                      ))}
                    </div>
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 100 }}>
      <div style={{ padding: "16px 20px 8px" }}>
        ...
        <div style={{ fontFamily: ios.font, fontSize: 15, color: ios.label3, marginTop: 2 }}>
          {games.length} NBA game{games.length !== 1 ? "s" : ""} · Live odds
        </div>
      </div>
      ...
      {!loading && (
        <div style={{ padding: "8px 20px" }}>
          {games.length === 0 && (
            <div style={{ background: ios.bg1, borderRadius: 16, padding: 24,
              textAlign: "center", fontFamily: ios.font, fontSize: 15, color: ios.label3 }}>
              No NBA games today, or odds not yet posted.
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between",
                    ...
                    <div>
                      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                        <span style={{ fontFamily: ios.font, fontSize: 14,
                          color: ios.label3 }}>{g.away_team_abbrev}</span>
                  ...
                  <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                    {g.spread_line != null && (
                      <div style={{ background: ios.bg2, borderRadius: 8, padding: "5px 10px" }}>
                        <div style={{ fontFamily: ios.mono, fontSize: 12,
                          color: ios.blue, fontWeight: 600 }}>
                          {g.home_team_abbrev} {g.spread_line > 0 ? "+" : ""}{g.spread_line}
                        </div>
                    ...
                    {g.total_line != null && (
                      <div style={{ background: ios.bg2, borderRadius: 8, padding: "5px 10px" }}>
                        <div style={{ fontFamily: ios.mono, fontSize: 12,
                          color: ios.purple, fontWeight: 600 }}>O/U {g.total_line}</div>
                    ...
                    {g.home_odds != null && (
                      <div style={{ background: ios.bg2, borderRadius: 8, padding: "5px 10px" }}>
                        <div style={{ fontFamily: ios.mono, fontSize: 12,
                          color: ios.green, fontWeight: 600 }}>{g.home_odds?.toFixed(2)}×</div>
                      ...
                      <div key={j} style={{ display: "flex", justifyContent: "space-between",
                        ...
                        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                          <span style={{ fontFamily: ios.font, fontSize: 11, color: ios.label3,
                            background: ios.bg3, padding: "1px 6px", borderRadius: 4 }}>
                            {p.team}
                          </span>
...
function InjuriesTab({ injuries, loading, error, onRetry }) {
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 100 }}>
      <div style={{ padding: "16px 20px 8px" }}>
        <div style={{ fontFamily: ios.font, fontWeight: 800, fontSize: 34,
          color: ios.label, letterSpacing: -0.5 }}>Injury Report</div>
        <div style={{ fontFamily: ios.font, fontSize: 15, color: ios.label3, marginTop: 2 }}>
          Live from ESPN · Factors into picks
        </div>
      </div>

      {error && <ErrBanner msg={error} onRetry={onRetry} />}
      {loading && <LoadingScreen message="Fetching injury report…" progress={60} />}

      {!loading && (
        <div style={{ padding: "8px 20px" }}>
          <div style={{ display: "flex", gap: 10, marginBottom: 16 }}>
            {[
              { label: "Out",        val: out.length,  color: ios.red   },
              { label: "Questionable",val: ques.length, color: ios.amber },
              { label: "Teams",      val: all.length,  color: ios.green  },
            ].map((s, i) => (
              <div key={i} style={{ background: ios.bg1, borderRadius: 12,
                padding: "10px 16px", flex: 1, textAlign: "center",
                border: `0.5px solid ${ios.sep}`, borderTop: `2px solid ${s.color}` }}>
                <div style={{ fontFamily: ios.font, fontWeight: 700,
                  fontSize: 24, color: s.color }}>{s.val}</div>
                <div style={{ fontFamily: ios.font, fontSize: 12, color: ios.label3 }}>{s.label}</div>
              </div>
            ))}
          </div>

          {[{ title: "● OUT", players: out, color: ios.red, status: "OUT" },
            { title: "● QUESTIONABLE", players: ques, color: ios.amber, status: "QUES" }]
            .map(({ title, players, color, status }) =>
              players.length > 0 && (
                <div key={status}>
                  <div style={{ fontFamily: ios.font, fontWeight: 600, fontSize: 13,
                    color, marginBottom: 8, letterSpacing: 0.3 }}>{title}</div>
                  <div style={{ background: ios.bg1, borderRadius: 16,
                    overflow: "hidden", marginBottom: 16, border: `0.5px solid ${ios.sep}` }}>
                    {players.map((p, i) => (
                      <div key={i} style={{ padding: "12px 16px",
                        borderBottom: i < players.length - 1 ? `0.5px solid ${ios.sep}` : "none",
                        display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <div>
                          <div style={{ fontFamily: ios.font, fontWeight: 600,
                            fontSize: 15, color: ios.label }}>{p.name}</div>
                          <div style={{ fontFamily: ios.font, fontSize: 12,
                            color: ios.label3, marginTop: 2 }}>
                            {p.team}{p.reason ? ` · ${p.reason}` : ""}
                          </div>
                        </div>
                        <span style={{ fontFamily: ios.font, fontSize: 13,
                          fontWeight: 700, color }}>{status}</span>
                      </div>
                    ))}
                  </div>
                </div>
          ...
          {out.length === 0 && ques.length === 0 && (
            <div style={{ background: ios.bg1, borderRadius: 16, padding: 24,
              textAlign: "center", border: `0.5px solid ${ios.sep}` }}>
              <div style={{ fontSize: 32, marginBottom: 8 }}>✅</div>
              <div style={{ fontFamily: ios.font, fontSize: 16, color: ios.green,
                fontWeight: 600, marginBottom: 4 }}>Clean Injury Report</div>
              <div style={{ fontFamily: ios.font, fontSize: 14, color: ios.label3 }}>
                No significant injuries for tonight's games
              </div>
            </div>
          )}
        </div>
...
function App() {
  ...
  const [loadingMsg, setLoadingMsg]     = useState("Waking up server…");
  ...
  const loadAll = useCallback(async () => {
    ...
    try {
      // Animate progress during the wait
      const steps = [
        [15, "Fetching NBA.com stats…"],
        [35, "Loading injury reports…"],
        [55, "Getting live odds…"],
        [75, "Running scoring engine…"],
        [90, "Building your multis…"],
      ];
      let stepIndex = 0;
      const ticker = setInterval(() => {
        if (stepIndex < steps.length) {
          const [prog, msg] = steps[stepIndex++];
      ...
      // Load slate and injuries in background
      ...
      setError(
        e.name === "AbortError"
          ...
          : `Could not reach the analysis server: ${e.message}`
      );
    } finally {
      setLoading(false);
    }
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column",
        ...
        {tab === "picks" && (
          <PicksTab picks={picks} loading={loading} loadingMsg={loadingMsg}
            ...
            lastUpdated={lastUpdated} legsScored={legsScored} gamesAnalyzed={gamesAnalyzed} />
        )}
        {tab === "slate" && (
          <SlateTab games={games} loading={loading} error={error} onRetry={loadAll} />
        )}
        {tab === "injuries" && (
          <InjuriesTab injuries={injuries} loading={loading} error={error} onRetry={loadAll} />
        )}
      </div>
